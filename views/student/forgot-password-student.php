    ...
    <div class="elementor-container elementor-column-gap-default">
        ...
        <div class="register-inner container justify-content-center pl-4">
            <div class="title2 w-100 pt-5 mt-2">
                ...
                <h2 class="mb-0">Studesnt Forgot Password</h2>
            </div>
            
            <form class="w-100 row " method="post" action="<?php echo base_url('students/MainStuController/forgetSednmailStu') ?>">
                            ...
                            <div class="register-inner" style="margin: 0 auto;">
                                <div class="row mrg20">
                                    <div class="col-md-12 col-sm-12 col-lg-12 p-0">
                                        ...
                                        <input class="rounded-pill" type="email" name="email" placeholder="Enter Valid Email ID" required>
