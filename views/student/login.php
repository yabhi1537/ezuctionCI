    ...
    <div class="elementor-container elementor-column-gap-default">
        ...
        <div class="register-inner container justify-content-center pl-4">
            <div class="title2 w-100 pt-5 mt-2">
                ...
                <h2 class="mb-0">Students Login</h2>
                <p class="mb-0">Enter into the world of endless opportunities. </p>
            </div>

            <form class="w-100 row " method="post" action="<?php echo base_url('students/LoginController/checklogin') ?>">
                            ...
                            <div class="register-inner" style="margin: 0 auto;">
                                <div class="row mrg20">
                                    <div class="col-md-12 col-sm-12 col-lg-12 p-0">
                                        <input class="rounded-pill" type="number" name="mobile" placeholder="Mobile Number">
                                        <span style="color: red;"><?php echo form_error('email') ?></span>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-lg-12 pt-4 p-0 ">
                                        <input class="rounded-pill" type="password" name="password"
                                    ...
                                    <div class="col-md-12 col-sm-12 col-lg-12 mt-50 my-5">
                                        ...
                                        <div class="d-flex align-items-center pb-4 mt-3">
                                            <p class="mb-0 me-2 px-2">Don't have an account?</p>
                                            <a href="<?php echo base_url('students/Register') ?>"> Register Now </a>
                                    
                                        </div>
                                            <div class="d-flex align-items-center m-0">
                                         <p class="mb-0 me-2 px-2">forgot password</p>
                                         <a href="<?php echo base_url('student/forgot-password-student') ?>"> Click Here </a>
                                      </div>
                                    </div>
                                </div>
                            </div>
