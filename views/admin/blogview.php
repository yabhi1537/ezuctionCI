                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="p-3 text-right">
                            ...
                            <?php } ?>
                                <a href="<?php echo base_url('admin/blogs/add'); ?>"><button class='btn btn-sm btn-primary mb-2'>New Blog</button></a>
                                    ...
                                    $i=1; 
                                        foreach($blogs as $blog){  ?>
                                            <tr>
                                               ...
                                               <td>
                                                   <a href="<?php echo base_url('admin/blog/edit/').$blog['id'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" ></i></a>&nbsp;&nbsp;&nbsp;
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('admin/BlogController/delBlog/')?>"+id,
