            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form action="<?php echo base_url('admin/BlogController/updateBlog/'.$blogsData[0]['id']) ?>" method="post" enctype="multipart/form-data">
                            <?php
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Enter Title"
                                            required value='<?php echo $blogsData[0]['title'] ?>'>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="tetx" name="heading" class="form-control" placeholder="Enter Heading"
                                            id="email" required value='<?php echo $blogsData[0]['heading'] ?>'>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" name="hdnImgName" id='hdnImgName' value='<?php echo $blogsData[0]['images'] ?>'>
                                        <input type="file" name="userfile" accept="image/*" class="form-control">
                                        </br>
                                        <img style="height: 130px;" src="<?php echo base_url('upload/blog/'.$blogsData[0]['images']); ?>" alt="" srcset="">
                                    </div>
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="metaTitle" class="form-control" placeholder="Enter Meta Title"
                                            required  value='<?php echo $blogsData[0]['meta_title'] ?>'>
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="tetx" name="metaDesc" class="form-control" placeholder="Enter Meta Description"
                                            id="email" required value='<?php echo $blogsData[0]['meta_description'] ?>'>
                                        <label id='email_message'></label>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="editor1"  class='form-control' id="description" cols="30" rows="10"><?php echo $blogsData[0]['description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
