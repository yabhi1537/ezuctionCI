            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form action="<?php echo base_url('admin/TeacherController/techUpdate/').$tecahers[0]['id'] ?>"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="names" class="form-control" placeholder="Enter Name"
                                            required value="<?php echo $tecahers[0]['name'] ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" name="email" class="form-control" placeholder="Enter Email"
                                            ...
                                            value="<?php echo $tecahers[0]['email'] ?>">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php if($tecahers[0]['gender']=="Male"){ ?>
                                        <input type="radio" name="gender" class="ml-5" value="Male" checked required>
                                        Male
                                        ...
                                        <?php }else if($tecahers[0]['gender']=="Female"){ ?>
                                        <input type="radio" name="gender" class="ml-5" value="Male" required> Male
                                        <input type="radio" name="gender" class="ml-5" value="Female" checked required>
                                        Female
                                        <input type="radio" name="gender" class="ml-5" value="Other" required> Other
                                        <?php }else if($tecahers[0]['gender']=="Other"){ ?>
                                        <input type="radio" name="gender" class="ml-5" value="Male" required> Male
                                        <input type="radio" name="gender" class="ml-5" value="Female" required> Female
                                        <input type="radio" name="gender" class="ml-5" value="Other" checked required>
                                        Other
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="mobile" class="form-control"
                                            ...
                                            value="<?php echo $tecahers[0]['phone'] ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="intro" id="" cols="30" rows="1" class="form-control"
                                            placeholder="Enter Brief Introduction" required
                                            value="<?php echo $tecahers[0]['intro'] ?>"><?php echo $tecahers[0]['intro'] ?></textarea>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="hqualification" id="hqualification" class="form-control">
                                            <option value="<?php echo $tecahers[0]['highest_qualification'] ?>">
                                                <?php echo $tecahers[0]['highest_qualification'] ?></option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php if($tecahers[0]['batch']=="Regular"){ ?>
                                        <input type="radio" name="batch" class="ml-5" value="Regular" checked required>
                                        Regular
                                        <input type="radio" name="batch" class="ml-5" value="Comptetitive" required>
                                        Comptetitive
                                        <?php }else if($tecahers[0]['batch']=="Comptetitive"){ ?>
                                        <input type="radio" name="batch" class="ml-5" value="Regular" required> Regular
                                        <input type="radio" name="batch" class="ml-5" value="Comptetitive" checked
                                            required>
                                        Comptetitive
                                        <?php }else{ ?>
                                        <input type="radio" name="batch" class="ml-5" value="Regular" required> Regular
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php if($tecahers[0]['typeinstitute']=="Individual"){ ?>
                                        <input type="radio" name="institute" class="ml-5" value="Individual" checked
                                            required>
                                        Individual
                                        <input type="radio" name="institute" class="ml-5" value="Coaching Center"
                                            required>
                                        Coaching Center
                                        <?php }else if($tecahers[0]['typeinstitute']=="Coaching Center"){ ?>

                                        <input type="radio" name="institute" class="ml-5" value="Individual" required>
                                        Individual
                                        <input type="radio" name="institute" class="ml-5" value="Coaching Center"
                                            checked required>
                                        Coaching Center
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php if($tecahers[0]['mode']=="Offline Only"){ ?>
                                        <input type="radio" name="mode" class="ml-5" value="Offline Only" checked required>
                                        Offline
                                        Only
                                        <input type="radio" name="mode" class="ml-5" value="Online Only" required> Online
                                        Only
                                        <input type="radio" name="mode" class="ml-5" value="Offline and Online Both"
                                            required>
                                        Offline and Online Both
                                        <?php }else if($tecahers[0]['mode']=="Online Only"){ ?>
                                        <input type="radio" name="mode" class="ml-5" value="Offline Only" required> Offline
                                        Only
                                        <input type="radio" name="mode" class="ml-5" value="Online Only" checked required>
                                        Online
                                        Only
                                        <input type="radio" name="mode" class="ml-5" value="Offline and Online Both"
                                            required>
                                        Offline and Online Both
                                        <?php }else if($tecahers[0]['mode']=="Offline And Online Both"){ ?>
                                        <input type="radio" name="mode" class="ml-5" value="Offline Only" required> Offline
                                        Only
                                        <input type="radio" name="mode" class="ml-5" value="Online Only" required> Online
                                        Only
                                        <input type="radio" name="mode" class="ml-5" checked
                                            value="Offline and Online Both" required>
                                        Offline and Online Both
                                        <?php }else{  ?>
                                        <input type="radio" name="mode" class="ml-5" value="Offline Only" required> Offline
                                        Only
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="teacherexp" id="teacherexp">
                                            <option value="<?php echo $tecahers[0]['total_techer_exp'] ?>">
                                                <?php echo $tecahers[0]['total_techer_exp'] ?></option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="inputState13" class="form-control" name="class[]"
                                            multiple="multiple">
                                            <option value="<?php echo $tecahers[0]['class'] ?>" selected>
                                                <?php echo $tecahers[0]['class'] ?></option>

                                            <!-- <option <?php echo $teachers[0]['class'] ?> ><?php echo $teachers[0]['class'] ?></option> -->
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="inputState15" class="form-control" name="board[]"
                                            multiple="multiple">
                                            <option value="<?php echo $tecahers[0]['board'] ?>" selected>
                                                <?php echo $tecahers[0]['board'] ?></option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="inputState14" class="subject form-control" name="subject[]"
                                            multiple="multiple">
                                            <option value="<?php echo $tecahers[0]['subject'] ?>" selected>
                                                <?php echo $tecahers[0]['subject'] ?></option>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="coaching" class="form-control"
                                            ...
                                            value="<?php echo $tecahers[0]['address'] ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="area" class="form-control" placeholder="Enter Area"
                                            required value="<?php echo $tecahers[0]['area'] ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="pincode" class="form-control"
                                            ...
                                            value="<?php echo $tecahers[0]['pincode'] ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="district" class="form-control" id=""
                                            ...
                                            value="<?php echo $tecahers[0]['distrcit'] ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="state" class="form-control" placeholder="Enter State"
                                            required value="<?php echo $tecahers[0]['state'] ?>">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Lankmark </label>
                                        <input type="text" name="landmark" class="form-control"
                                            placeholder="Enter Landmark" value="<?php echo $tecahers[0]['landmark'] ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="refer" class="form-control"
                                            ...
                                            value="<?php echo $tecahers[0]['referby'] ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="password" name="password" class="form-control"
                                            ...
                                            value="<?php echo $tecahers[0]['password'] ?>">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <img src="<?php echo base_url('upload/').$tecahers[0]['image'] ?>" alt=""
                                        height="80" width="80">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">Profile </label>
                                    <input type="hidden" name="hdnimage" class="form-control" placeholder="Enter Title" value="<?php echo $tecahers[0]['image'] ?>">
