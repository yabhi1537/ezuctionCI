                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="names" class="form-control" placeholder="Enter Name"
                                            required value='<?php echo $teachers[0]->name ?>'>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Email<span class="compulsary">*</span> </label>
                                        <input type="email" name="email" class="form-control" placeholder="Enter Email"
                                            id="email" required onChange="return validateEmail();" value='<?php echo $teachers[0]->email ?>'>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="radio" <?php echo ($teachers[0]->gender == "Male")? "selected='selected'" : ""  ?>  name="gender" class="ml-5" value="male" required> Male
                                        <input type="radio" <?php echo ($teachers[0]->gender == "Female")? "selected='selected'" : ""  ?>  name="gender" class="ml-5" value="female" required> Female
                                        <input type="radio" <?php echo ($teachers[0]->gender == "Other")? "selected='selected'" : ""  ?>  name="gender" class="ml-5" value="other" required> Other
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="mobile" class="form-control"
                                            placeholder="Enter Mobile Number" required value='<?php echo $teachers[0]->phone ?>' >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="intro" id="" cols="30" rows="1" class="form-control"
                                            placeholder="Enter Brief Introduction" required><?php echo $teachers[0]->phone ?></textarea>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="hqualification" id="hqualification" class="form-control">
                                            <option <?php echo ($teachers[0]->highest_qualification == "Graduation") ? "selected" : "" ?> value="Graduation">Graduation</option>
                                            <option <?php echo ($teachers[0]->highest_qualification == "Post-Graduation") ? "selected" : "" ?> value="Post-Graduation">Post-Graduation</option>
                                            <option <?php echo ($teachers[0]->highest_qualification == "Ph.D") ? "selected" : "" ?> value="Phd">Ph.D</option>
                                            <option <?php echo ($teachers[0]->highest_qualification == "Post Doc") ? "selected" : "" ?> value="Post Doc">Post Doc</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="otherhigh" class="form-control" id="exampleInputEmail1"
                                            placeholder="Other Highest Qualification" value='<?php echo $teachers[0]->otherhighest_qualification ?>'>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Type of Batch<span class="compulsary">*</span>
                                        </label><br>
                                        <input type="radio" <?php echo ($teachers[0]->batch == "Regular") ? "selected" : "" ?> name="batch" class="ml-5" value="Regular" required> Regular
                                        <input type="radio" <?php echo ($teachers[0]->batch == "Competitive") ? "selected" : "" ?> name="batch" class="ml-5" value="Comptetitive" required>
                                        Comptetitive
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Mode of Delivery<span
                                                class="compulsary">*</span> </label><br>
                                        <input type="radio" <?php echo ($teachers[0]->mode == "offline") ? "selected" : "" ?> name="mode" class="ml-5" value="offline" required> Offline
                                        Only
                                        <input type="radio" <?php echo ($teachers[0]->mode == "online") ? "selected" : "" ?> name="mode" class="ml-5" value="online" required> Online
                                        Only
                                        <input type="radio" <?php echo ($teachers[0]->mode == "offlineandonline") ? "selected" : "" ?> name="mode" class="ml-5" value="offlineandonline" required>
