            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form action="<?php echo base_url('admin/EventController/updateEvent/'.$eventData[0]['id']) ?>" method="post"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Enter Title"
                                            required value='<?php echo $eventData[0]['title'] ?>'>
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="date" name="date" class="form-control" placeholder="Enter Heading"
                                            id="email" required value='<?php echo $eventData[0]['dates'] ?>'>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="time" name="time" class="form-control" placeholder="Enter Heading"
                                            id="email" required value='<?php echo $eventData[0]['time'] ?>'>
                                        <label id='email_message'></label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                    <input type="hidden" name="hdnImgName" id='hdnImgName' value='<?php echo $eventData[0]['images'] ?>'>
                                        ...
                                        <img style="height: 130px;" src="<?php echo base_url('upload/blog/'.$eventData[0]['images']); ?>" alt="" srcset="">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="exampleInputEmail1">Price<span class="compulsary">*</span> </label>
                                        <input type="text" name="price" class="form-control" placeholder="Enter price"
                                            required value='<?php echo $eventData[0]['price'] ?>'>
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="exampleInputEmail1">Location<span class="compulsary">*</span> </label>
                                        <input type="text" name="location" class="form-control" placeholder="Enter location"
                                            id="email" required value='<?php echo $eventData[0]['location'] ?>'>
                                        <label id='email_message'></label>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="exampleInputEmail1">Description<span class="compulsary">*</span> </label>
                                        <input type="text" name="description" class="form-control" placeholder="Enter description"
                                            id="email" required value='<?php echo $eventData[0]['description'] ?>'>
                                        <label id='email_message'></label>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="exampleInputEmail1">Links<span class="compulsary">*</span> </label>
                                        <input type="link" name="linkadd" class="form-control" placeholder="Enter Links"
                                            id="email" required value='<?php echo $eventData[0]['links'] ?>'>
                                        <label id='email_message'></label>
                                    </div>
                                </div>
                            </div>
