            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form action="<?php echo base_url('admin/AddStudents/updateStudent/').$student[0]['id'] ?>" method="post"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="names" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter Name" required value="<?php echo $student[0]['name'] ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" name="email" class="form-control" id="exampleInputEmail1"
                                            ...
                                            value="<?php echo $student[0]['email'] ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="radio" name="gender" class="ml-5" checked value="male"> Male
                                        <input type="radio" name="gender" class="ml-5" value="female"> Female
                                        <input type="radio" name="gender" class="ml-5" value="other"> Other
                                        <?php }else if($student[0]['gender']=="female"){ ?>
                                        <input type="radio" name="gender" class="ml-5" value="male"> Male
                                        <input type="radio" name="gender" class="ml-5" checked value="female"> Female
                                        <input type="radio" name="gender" class="ml-5" value="other"> Other
                                        <?php }else if($student[0]['gender']=="other"){ ?>
                                        <input type="radio" name="gender" class="ml-5" value="male"> Male
                                        <input type="radio" name="gender" class="ml-5" value="female"> Female
                                        <input type="radio" name="gender" class="ml-5" checked value="other"> Other
                                        <?php }else{ ?>
                                        <input type="radio" name="gender" class="ml-5" value="male"> Male
                                        <input type="radio" name="gender" class="ml-5" value="female"> Female
                                        <input type="radio" name="gender" class="ml-5" value="other"> Other
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="mobile" class="form-control" id="number"
                                            ...
                                            required value="<?php echo $student[0]['number'] ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="schoolname" class="form-control"
                                            ...
                                            value="<?php echo $student[0]['schoolname'] ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="class" id="class" class="form-control" required>
                                            <option value="<?php echo $student[0]['class'] ?>">
                                                <?php echo $student[0]['class'] ?></option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="subjectt" id="tution" class="form-control" required>
                                            <option value="<?php echo $student[0]['tutionsubject'] ?>">
                                                <?php echo $student[0]['tutionsubject'] ?></option>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="address" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter Address" value="<?php echo $student[0]['address'] ?>">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Area </label>
                                        <input type="text" name="area" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter Area" value="<?php echo $student[0]['area'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="pincode" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter Pin Code" value="<?php echo $student[0]['pincode'] ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="district" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter District" value="<?php echo $student[0]['district'] ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="state" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter State" value="<?php echo $student[0]['state'] ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="password" name="password" class="form-control"
                                            ...
                                            value="<?php echo $student[0]['password'] ?>">
                                    </div>
                                </div>
