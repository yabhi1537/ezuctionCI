                ...
                <div class="login-register-wrap w-100">
                    ...
                    <div class="register-inner container">
                        <div class="title2 w-100 text-center pt-5 mt-2">
                            <h2 class="mb-0">Batches AND Seats</h2>
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-6">
                            <div class="register-wrap w-100 pt-5">
                                <div class="register-inner" style="margin: 0 auto;">
                                    ...
                                    <form class="w-100" method="post" action="<?php echo base_url('Batches/storedata') ?>" enctype="multipart/form-data">
                                        <div class="row mrg20 ">
                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                <label class="form-label">To Batch Time</label>
                                                <input class="rounded-pill" type="time" name="totime" placeholder="Time">
                                                <span style="color: red;"><?php echo form_error('totime') ?></span>
                                            </div>
                                            
                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                <label class="form-label">From Batch Time</label>
                                                <input class="rounded-pill" type="time" name="fromtime" placeholder="Time">
                                                <span style="color: red;"><?php echo form_error('fromtime') ?></span>
                                            </div>
                                            
                                             <div class="col-md-12 col-sm-12 col-lg-12">
                                                <label class="form-label">Total Seats</label>
                                                <input class="rounded-pill" type="number" name="totalseat" placeholder="Total Seats">
                                                <span style="color: red;"><?php echo form_error('totalseat') ?></span>
                                            </div>
                                            
                                             <div class="col-md-12 col-sm-12 col-lg-12">
                                                <label class="form-label">Available Seats</label>
                                                <input class="rounded-pill" type="number" name="availableseat" placeholder="Availabel Seats">
                                                <span style="color: red;"><?php echo form_error('availableseat') ?></span>
                                            </div>
                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                <label class="form-label">Class</label>
                                                <input class="rounded-pill" type="text" name="class" placeholder="Enter Class">
                                                <span style="color: red;"><?php echo form_error('class') ?></span>
                                            </div>
                                            
                                             <div class="col-md-12 col-sm-12 col-lg-12">
                                                <label class="form-label">Message</label>
                                                <textarea rows="15" cols="80" name="message" placeholder="Enter Message" ></textarea>
                                             ...
                                             <div class="col-md-12 col-sm-12 col-lg-12 mt-50 py-5 pl-2">
